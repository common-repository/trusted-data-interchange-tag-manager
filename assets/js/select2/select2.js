...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
                ...
                opts.query = this.bind(function (query) {
                    ...
                    process=function(element, collection) {
                        ...
                        if (element.is("option")) {
                            var hasData = element.data("html");
                            if (hasData === "") {
                                return;
                            }
                            if (query.matcher(term, hasData ? hasData : element.text(), element)) {
                                var data = {id:element.attr("value"), element: element.get(), css: element.attr("class"), disabled: equal(element.attr("disabled"), "disabled") };
                                if (hasData) {
                                    data.html = hasData;
                                }
        ...
        positionDropdown: function() {
            var offset = this.container.offset(),
                ...
                width = this.container.children("a").eq(0).outerWidth(false),
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        setPlaceholder: function () {
            ...
            if (this.opts.element.val() === "" && placeholder !== undefined) {
                ...
                this.selection.find("span").html(this.opts.escapeMarkupContainer(placeholder));
        ...
        updateSelection: function (data) {
            ...
            if (formatted !== undefined) {
                container.append(this.opts.escapeMarkupContainer(formatted));
            }
    ...
    var escapeMarkupCommon = function (markup) {
        var replace_map = {
            '\\': '&#92;',
            '&': '&amp;',
            '<': '&lt;',
    ...
    $.fn.select2.defaults = {
        ...
        formatResult: function(result, container, query, escapeMarkup) {
            ...
            if (result.html) {
                ...
                var data = result.html.find(".data");
                if (data.length) {
                    markMatch(data.text(), query.term, markup, escapeMarkup);
                    data.html(markup.join(""));
                }
        ...
        escapeMarkup: escapeMarkupCommon,
        escapeMarkupContainer: escapeMarkupCommon,
        blurOnChange: false,
        selectOnBlur: false,
